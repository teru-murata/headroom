...
The proxy routes eligible HTTP request content through local compression before
the provider sees it. MCP tools operate after the LLM receives content. They
handle different data and do not double-compress.
